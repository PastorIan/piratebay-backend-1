...
public class DepartmentContoller {
    ...
    public ResponseEntity<List<DepartamentModel>> findAllCities(@RequestHeader("Authorization") String authorization) { // bearer asdasdasdasd
        ...
        return new ResponseEntity<>( this.departmentBl.findAllCities(), HttpStatus.OK);
    }
}
